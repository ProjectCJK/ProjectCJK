...
namespace Units.Stages.Modules.StatsModules.Units.Buildings.Units
{
    ...
    public class DeliveryLodgingStatsModule : BuildingStatsModule, IDeliveryLodgingStatsModule
    {
        ...
        private void UpdateDeliveryLodgingStatsModule()
        {
            ...
            CurrentDeliveryLodgingOption1Value = Enumerable.Range(0, DeliveryLodgingOption1ValueData.GetLength(0))
                .Where(i =>
                    ...
                    DeliveryLodgingOption1ValueData[i, 2] ==
                    VolatileDataManager.Instance.CurrentStageLevel.ToString() &&
                    DeliveryLodgingOption1ValueData[i, 3] == CurrentDeliveryLodgingOption1Level.ToString())
                .Select(i =>
                    ParserModule.ParseOrDefault(DeliveryLodgingOption1ValueData[i, 4],
            ...
            CurrentDeliveryLodgingOption2Value = Enumerable.Range(0, DeliveryLodgingOption2ValueData.GetLength(0))
                .Where(i =>
                    ...
                    DeliveryLodgingOption2ValueData[i, 2] ==
                    VolatileDataManager.Instance.CurrentStageLevel.ToString() &&
                    DeliveryLodgingOption2ValueData[i, 3] == CurrentDeliveryLodgingOption2Level.ToString())
                .Select(i =>
                    ParserModule.ParseOrDefault(DeliveryLodgingOption2ValueData[i, 4],
            ...
            NextDeliveryLodgingOption1Value = Enumerable.Range(0, DeliveryLodgingOption1ValueData.GetLength(0))
                ...
                .Select(i =>
                    ParserModule.ParseOrDefault(DeliveryLodgingOption1ValueData[i, 4], NextDeliveryLodgingOption1Value))
                .FirstOrDefault();
            ...
            NextDeliveryLodgingOption2Value = Enumerable.Range(0, DeliveryLodgingOption2ValueData.GetLength(0))
                ...
                .Select(i =>
                    ParserModule.ParseOrDefault(DeliveryLodgingOption2ValueData[i, 4], NextDeliveryLodgingOption2Value))
                .FirstOrDefault();

            RequiredGoldToUpgradeDeliveryLodgingOption1 = Enumerable
                .Range(0, DeliveryLodgingOption1CostData.GetLength(0))
                .Where(i =>
                ...
                .Select(i => ParserModule.ParseOrDefault(DeliveryLodgingOption1CostData[i, 4],
                    RequiredGoldToUpgradeDeliveryLodgingOption1))
                .FirstOrDefault();

            RequiredGoldToUpgradeDeliveryLodgingOption2 = Enumerable
                .Range(0, DeliveryLodgingOption2CostData.GetLength(0))
                .Where(i =>
                ...
                .Select(i => ParserModule.ParseOrDefault(DeliveryLodgingOption2CostData[i, 4],
            ...
            RequiredOption1LevelToUpgradeDeliveryLodgingLevel = Enumerable.Range(0, DeliveryLodgingData.GetLength(0))
                ...
                .Select(i =>
                    ParserModule.ParseOrDefault(DeliveryLodgingData[i, 6],
                        RequiredOption1LevelToUpgradeDeliveryLodgingLevel))
                .FirstOrDefault();

            RequiredDeliveryLodgingLevelToUpgradeOption2 = Enumerable
                .Range(0, DeliveryLodgingOption2CostData.GetLength(0))
                .Where(i =>
                    DeliveryLodgingOption2CostData[i, 1] == $"{BuildingKey}" &&
                    DeliveryLodgingOption2CostData[i, 2] == VolatileDataManager.Instance.CurrentStageLevel.ToString() &&
                    DeliveryLodgingOption2CostData[i, 3] == CurrentDeliveryLodgingOption2Level.ToString())
                .Select(i => ParserModule.ParseOrDefault(DeliveryLodgingOption2CostData[i, 5],
        ...
        {
            foreach (IDeliveryMan deliveryMan in _currentSpawnedDeliveryMans)
