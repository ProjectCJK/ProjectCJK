...
namespace Units.Stages.Units.Zones.Units.BuildingZones.Modules.UnlockZones.Abstract
{
    public interface IUnlockZone : IRegisterReference<Transform, IBuildingInventoryModule, IBuildingInventoryModule, string, string>, IItemReceiver
    {
