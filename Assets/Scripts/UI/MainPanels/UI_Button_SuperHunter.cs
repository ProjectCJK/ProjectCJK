...
{
    public class UI_Button_SuperHunter : MonoBehaviour
    {
        ...
        {
            GetComponent<Button>().onClick.AddListener(() => UIManager.Instance.UI_Panel_Main.UI_Panel_PopUp_Reward.Activate(EPopUpPanelType.SuperHunter, 0, () => { VolatileDataManager.Instance.SuperHunterTrigger = true;}, null));
        }
