...
//     private string adUnitId = "3c830d18eb57129f";
//
//     // #endif
//     int retryAttempt;
//     private void Start()
...
//     }
//
//     private void ShowRewardedAd(string adUnitKey, Action<MaxSdk.Reward, MaxSdkBase.AdInfo> rewardAction)
//     {
//         // 광고 시청 시도 로깅
...
//         try
//         {
//             ES3.Save(Consts.ADS_SHOWN_TODAY_SAVE, adsShownToday, ES3.settings);
//             ES3.Save(Consts.LAST_AD_SHOW_DATE_SAVE, lastAdShownDate, ES3.settings);
//
