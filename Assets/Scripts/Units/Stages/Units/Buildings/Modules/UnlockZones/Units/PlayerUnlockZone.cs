...
namespace Units.Stages.Units.Buildings.Modules.UnlockZones.Units
{
    ...
    {
        [Header("=== Unit Accessor Settings ===")] [Header("--- Player ---")] [SerializeField]
        private bool _inputAccessPlayer;
