...
namespace Managers
{
    ...
    public class CostumeManager : Singleton<CostumeManager>
    {
        ...
        private readonly UI_Panel_Costume_Gacha _uiPanelCostumeGacha = MainSceneUIManager.Instance.UI_Panel_CostumeGacha;
        private readonly UI_Panel_Costume _uiPanelCostume = MainSceneUIManager.Instance.UI_Panel_Costume;
        ...
        public void RegisterReference()
        {
            ...
            MainSceneUIManager.Instance.UI_Button_CostumeGachaPanel.onClick.AddListener(ActivateCostumeGacha);
            MainSceneUIManager.Instance.UI_Button_CostumePanel.onClick.AddListener(ActivateCostumePanel);
        }
