...
namespace UI
{
    ...
    public class UI_BuildingEnhancement : MonoBehaviour, IUI_BuildingEnhancement
    {
        ...
        [Header("=== 슬롯 1 ===")] [SerializeField]
        private Image _image_Slot1_Icon;
            ...
            Action onClickUpgradeButtonForBuildingOption2)
        {
            ...
            else
            {
                if (CurrencyManager.Instance.Gold >= requiredGoldToUpgradeBuildingOption1)
                {
                    _text_Slot2_UpgradeButton_RequiredValue.text =
                        $"{_text_Slot2_UpgradeButton_RequiredValue.text.Split(' ')[0]} {requiredGoldToUpgradeBuildingOption1}";
                    _button_Slot2_UpgradeButton.gameObject.SetActive(true);
                }
                else
                {
                    _text_Slot2_NotEnoughButton_RequiredValue.text =
                        $"{_text_Slot2_NotEnoughButton_RequiredValue.text.Split(' ')[0]} {requiredGoldToUpgradeBuildingOption1}";
            ...
            else
            {
                if (requiredBuildingLevelToUpgradeOption2 <= currentBuildingLevel)
                {
                    ...
                    {
                        _text_Slot3_UpgradeButton_RequiredValue.text =
                            $"{_text_Slot3_UpgradeButton_RequiredValue.text.Split(' ')[0]} {requiredGoldToUpgradeBuildingOption2}";
                        _button_Slot3_UpgradeButton.gameObject.SetActive(true);
                    }
                    else
                    {
                        _text_Slot3_NotEnoughButton_RequiredValue.text =
                            $"{_text_Slot3_NotEnoughButton_RequiredValue.text.Split(' ')[0]} {requiredGoldToUpgradeBuildingOption2}";
                        _button_Slot3_NotEnoughButton.gameObject.SetActive(true);
                    }
                }
                else
                {
                    _text_Slot3_NotEnoughLevelButton_RequiredValue.text =
                        $"Required Building Level {requiredBuildingLevelToUpgradeOption2}";
