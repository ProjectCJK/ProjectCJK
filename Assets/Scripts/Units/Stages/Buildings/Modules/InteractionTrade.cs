...
{
    public interface IInteractionTrade : IRegisterReference<IBuildingInventoryModule, List<Tuple<EMaterialType, EProductType>>>, IItemReceiver
    {
    ...
    public class InteractionTrade : MonoBehaviour, IInteractionTrade
    {
        ...
        public List<Tuple<EMaterialType, EProductType>> InputItemKey { get; private set; }
        
        private IBuildingInventoryModule _buildingInventoryModule;
        
        public void RegisterReference(IBuildingInventoryModule buildingInventoryModule, List<Tuple<EMaterialType, EProductType>> inputItemKey)
        {
        ...
        public bool HasMatchingItem(Tuple<EMaterialType, EProductType> InventoryKey) => _buildingInventoryModule.HasMatchingItem(InventoryKey);

        public bool CanReceiveItem() => _buildingInventoryModule.CanReceiveItem();
        public void RegisterReference(IBuildingInventoryModule instance1, List<Tuple<EMaterialType, EProductType>> instance2, IItemReceiver instance3)
        {
